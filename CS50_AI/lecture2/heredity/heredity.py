...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        trait_probability = PROBS['trait'][num_genes][person in have_trait]
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        for gene_value in probabilities[person]['gene']:
            probabilities[person]['gene'][gene_value] /= gene_sum

        trait_sum = sum(probabilities[person]['trait'].values())
        for tratit_value in probabilities[person]['trait']:
            probabilities[person]['trait'][tratit_value] /= trait_sum
